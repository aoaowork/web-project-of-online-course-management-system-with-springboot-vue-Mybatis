            ...
            <el-header id="elDaoHang">
                ...
                <el-menu
                    ...
                    <el-submenu index="2" class="items">
                        ...
                        <el-menu-item index="5"><span id="dhTextC" class="dhClaText subText">个人主页</span></el-menu-item>
            ...
            <el-main>
                ...
                <el-tabs type="border-card"  @tab-click="tabController">
                    ...
                    <el-tab-pane label="我学的课" class="tab-pane">
                        ...
                        <!-- 学生课程 -->
                        <el-row>
                            <el-col :span="6" v-for="(item,index) in studyCourse" :key="index" class="CourseCard">
                                <el-card :body-style="{ padding: '0px' }" class="courseCards">
...
// 提交并关闭对话框
submitAndClose() {
        this.updateUserInfo(); // 调用更新逻辑
        this.$router.push({ name: 'UserMainPage' }); // 跳转到主页面
    },
    // 取消并关闭对话框
    cancelAndClose() {
        this.updateUserInfoDialogVisible = false; // 关闭对话框
        this.$router.push({ name: 'UserMainPage' }); // 跳转到主页面
    },
...
<style scoped>
     ...
     */
        ...
        background-color: #2f279e;
        /* 设置底色扩张至边框 */
        outline: #2f279e solid 10px;
    }
    /* 取消导航栏底框颜色 */
    .el-menu.el-menu--horizontal {
        border-bottom: solid 1px #2f279e;
    }
    /* 取消激活栏下划线 */
    .el-menu--horizontal>.el-menu-item.is-active,
    .el-menu--horizontal>.el-submenu.is-active{
        border-bottom: 2px solid #2f279e;
    }
    /* 导航栏文字样式 */
    .dhClaText {
        font-size: 20px;
